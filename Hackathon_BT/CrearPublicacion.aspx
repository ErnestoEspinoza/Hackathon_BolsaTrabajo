...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid MyContainer forms" style="justify-content:center">
        <h1>Crear publicación</h1>
        <div role="form">
            <div class="form-group col-lg-8 col-md-10 col-sm-12 forms">
                <label>Asunto</label>
                <input type="text" class="form-control" id="asunto" placeholder="Asunto de la publicación"/>
            </div>
            <div class="form-group col-lg-8 col-md-10 col-sm-12 forms">
                <label>Puesto</label>
                <select class="form-control col-lg-8 col-md-10 col-sm-12" id="puesto" required="required">
                    <option value="seleccione" disabled="disabled" selected="selected" hidden="hidden">Seleccione</option>
                    <option value="cajero">Cajero</option>
                </select>
           </div>
                <div class="from-group col-lg-8 col-md-10 col-sm-12 forms">
                    <label>Descripción</label>
                <textarea class="form-control col-lg-8 col-md-10 col-sm-12" style="width: 100%; height: 100%;" name="textarea" placeholder="Descripción y requerimientos" id="descripcion" style="width:250px;height:150px;"></textarea>
                </div>
            ...
            <div class=" col-lg-8 col-md-10 col-sm-12 forms text-center" style="margin-bottom:10px;">
